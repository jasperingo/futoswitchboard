...
<%@page import="switchboard.filters.PaginationFilter"%>
...
<div>
    <ul class="pagination pagination-md my-4">
        <% if (thePage > 1) { %>
        <li class="page-item">
            <a class="page-link text-success" href="<%= request.getParameter("url") %>page=<%= thePage-1%>">Previous</a>
        </li>
        <% } else { %>
        ...
        <li class="page-item">
            <a class="page-link text-success" href="<%= request.getParameter("url") %>page=<%= thePage+1%>">Next</a>
        </li>
        <% } else { %>
        <li class="page-item disabled">
